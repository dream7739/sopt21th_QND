...
class FragmentMakedSurveyList : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater!!.inflate(R.layout.fragment_makedsurvey, container, false)
...
//        userIdData.data.user_id = 10

        val makedListCallback = networkService!!.getMakedSurvey(user_id)
        makedListCallback.enqueue(object : Callback<GetMySurveyListResult> {
